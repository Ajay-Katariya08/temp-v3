            ...
            series: [
                {
                    ...
                    data: productData.map((item, index) => ({
                        value: item.value,
                        itemStyle: {
                            color: index === 0 ? theme('chart-primary') : index === 1 ? theme('chart-secondary') : '#bbcae14d',
                        },
                    })),
                },
            ],
...
function generateBarData() {
    ...
    const colors = [theme('chart-primary'), theme('chart-secondary'), theme('chart-alpha'), '#bbcae14d']
...
function generateAreaData() {
    const labels = ['A', 'B', 'C', 'D', 'E', 'F', 'G']
    const colors = [theme('chart-primary'), theme('chart-beta'), theme('chart-secondary'), '#bbcae14d']
